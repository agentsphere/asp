...
use crate::provider::{AgentProvider, BuildPodParams, ProgressEvent};
...
mod tests {
    ...
    fn parse_progress_valid_assistant_text() {
        ...
        assert_eq!(event.kind, crate::provider::ProgressKind::Text);
    ...
    fn parse_progress_error_event() {
        ...
        assert_eq!(event.kind, crate::provider::ProgressKind::Error);
    ...
    fn parse_progress_result_success() {
        ...
        let event = provider.parse_progress(line).unwrap();
        assert_eq!(event.kind, crate::provider::ProgressKind::Completed);
    }
