...
use crate::cli_invoke::StructuredResponse;
...
pub async fn run_validation(
    ...
    if let Err(e) =
        platform_secrets::llm_providers::update_validation_status(pool, config_id, user_id, status)
            .await
    {
...
async fn read_result_text(
    ...
    use crate::claude_cli::CliMessage;
...
mod tests {
    ...
    fn test_output_format_tools_with_names() {
        ...
        let resp = StructuredResponse {
            text: "text".into(),
            tools: vec![crate::cli_invoke::ToolRequest {
