...
pub async fn run(state: crate::state::AgentState, cancel: tokio_util::sync::CancellationToken) {
...
async fn handle_service_event(state: &crate::state::AgentState, svc: &Service, kind: ProgressKind) {
